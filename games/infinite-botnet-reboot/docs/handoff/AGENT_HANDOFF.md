...
Domain modules:
- `src/worker/domain/economy/`
- `src/worker/domain/war.ts`
- `src/worker/domain/matrix.ts`
- `src/worker/domain/narrative/`
- `src/worker/domain/phases/`
- `src/worker/domain/upgrades/`
...
- `docs/project/README.md`: project setup, runtime notes, command list.
- `docs/tracker/REFONTE_TRACKER.md`: milestone status and active sprint board.
- `docs/balance/BALANCE_REFERENCE.md`: balance notes and guidance.
- `docs/lore/LORE_AND_CINEMATIC_BLUEPRINT.md`: canonical P0 lore cinematic design.
- `docs/handoff/AGENT_HANDOFF.md`: this document.
...
- `src/worker/domain/phases/`.
- `src/worker/domain/upgrades/` for strict chain/prereq behavior.
- `src/worker/domain/narrative/templates.ts` for reward phase gating.
...
- `docs/tracker/REFONTE_TRACKER.md`
- `docs/balance/BALANCE_REFERENCE.md`
- `docs/lore/LORE_AND_CINEMATIC_BLUEPRINT.md`
...
If this file and `docs/tracker/REFONTE_TRACKER.md` disagree on roadmap state, treat `docs/tracker/REFONTE_TRACKER.md` as source of truth for milestone status.
