...
- 2026-04-17: Cinematic transition architecture started under `src/app/cinematics/lore/` with per-scene files, a shared Canvas runtime helper layer, and a Scene 1 Canvas visual prototype.
